...
const STEPS = [
  ...
  { n: '٢', title: 'نثبّته بالأدلّة المتاحة', body: 'نقرأ الإشارات، ونوضّح ما نعرفه وما نحتاجه قبل رفع الثقة.' },
  { n: '٣', title: 'نشغّل الإصلاح', body: 'تعديل قائمة، ضبط حملة، مراقبة مخزون، تحسين ظهور، أو تجهيز منصة جديدة.' },
