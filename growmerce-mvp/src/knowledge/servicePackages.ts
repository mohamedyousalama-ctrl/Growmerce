...
export const PRICING_PACKAGES: PricingPackage[] = [
  ...
  },
  {
    ...
    includes: ['مراقبة أسبوعية للمنصات', 'إدارة الكتالوج/القائمة', 'تقويم الحملات', 'فحوص الأسعار', 'فحوص صحة الحساب', 'تنسيق PPC/VFD', 'تقرير شهري'],
  },
  {
    ...
    includes: ['مراقبة يومية', 'تواصل مع AM المنصات', 'تقارير GMV', 'دفاع عن fail rate/النفاد/صحة الحساب', 'مراجعة استراتيجية شهرية', 'توسّع لمنصات جديدة'],
  },
];
